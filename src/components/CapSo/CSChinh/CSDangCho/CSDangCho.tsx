...
import classes from '../CSDangCho/CSDangCho.module.css'
        ...
        <div className={classes.Equi}>
            ...
            <div className={classes.Combobox2}>
                ...
                <select 
                    ...
                    <option id='default' value="/capsodangcho">Đang chờ</option>
